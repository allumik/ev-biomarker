...
```{python}
# maybe a table-like plot of the changes?
# or just a scatter plot with the cor at y and phases at x, and stat signf marked with *?
# it has to be a long rectangle to fit below the other plots
ccht_bio_stat = 
ccht_uf_stat =
