...
frac_params = {
  "batch_size": 512,
  "epochs": 500, # looking at loss plot then 500 seems to be already enough, and we don't need the fractions really
...
vae_params = {
  "batch_size": 512,
  "hidden_size": 256,
  "epoch_num": 5000 # looking at loss plot then 500 seems to be already enough
}
