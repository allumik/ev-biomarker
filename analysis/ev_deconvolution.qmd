...
no_go_celltype = list(count_tmp[count_tmp < 100].index) + ['eHormones', 'sHormones', 'dHormones', 'Immune_Lymphoid', 'Immune_Myeloid']
the_condition = "celltype not in @no_go_celltype & celltype not in @sc_dat.var.index & Endometrial_pathology == 'C'"
