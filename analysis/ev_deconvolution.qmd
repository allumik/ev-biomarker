...
if not snapshot_an_loc.exists():
  ...
  sc_dat.read_h5ad(snapshot_an_loc)
...
```{python}
funk.biplot_fractions(frac_pred, comb_uf_pheno, hue="cyclephase", palette="Set1", style="group")
```
...
funk.biplot_fractions(frac_pred_gen, comb_uf_pheno, hue="cyclephase", palette="Set1", style="group")
"""
...
```{python}
funk.biplot_fractions(frac_tmp, comb_uf_pheno, hue="cyclephase", palette="Set1", style="group")
```
...
funk.biplot_fractions(frac_pred_gen, comb_uf_pheno, hue="cyclephase", palette="Set1", style="dataset")
"""
...
```{python}
funk.biplot_fractions(frac_tmp, comb_uf_pheno, hue="cyclephase", palette="Set1", style="dataset")
```
...
```{python}
funk.biplot_fractions(frac_pred, ccht_uf_pheno, hue="cyclephase", palette="Set1", style="group")
```
...
funk.biplot_fractions(frac_pred_gen, ccht_uf_pheno, hue="cyclephase", palette="Set1", style="group")
"""
...
```{python}
funk.biplot_fractions(frac_tmp, ccht_uf_pheno, hue="cyclephase", palette="Set1")
```
...
funk.biplot_fractions(frac_pred_gen, ccht_uf_pheno, hue="cyclephase", palette="Set1")
"""
...
funk.biplot_fractions(
  ...
  hue="status_rif", palette="flare", style="no_lb"
  )
